  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      t.exports.installTimerFunctions = function (t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = o.bind(r)), (t.clearTimeoutFn = i.bind(r)))
        ...
        v = (function (t) {
          ...
          function v(t, e) {
            ...
            !(function (t, e) {
              ...
              (n.opts = e),
              (0, l.installTimerFunctions)(a(n), e),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.engine;
                  this.subs.push(
                    (0, y.on)(t, "ping", this.onping.bind(this)),
                    (0, y.on)(t, "data", this.ondata.bind(this)),
                    (0, y.on)(t, "error", this.onerror.bind(this)),
                    (0, y.on)(t, "close", this.onclose.bind(this)),
                    (0, y.on)(
                      this.decoder,
                      "decoded",
            ...
            (n = [
              {
                ...
                value: function () {
                  if (!this.subs) {
                    var t = this.io;
                    this.subs = [
                      (0, h.on)(t, "open", this.onopen.bind(this)),
                      (0, h.on)(t, "packet", this.onpacket.bind(this)),
                      (0, h.on)(t, "error", this.onerror.bind(this)),
                      (0, h.on)(t, "close", this.onclose.bind(this)),
                    ];
                  }
                },
              },
          ...
          function h(t) {
            ...
            return (
              ...
              t
                ...
                : n.host && (n.hostname = d(n.host).host),
              b(f(e), n),
              (e.secure =
                null != n.secure
                  ? n.secure
              ...
              "string" == typeof e.opts.query &&
                (e.opts.query = v.decode(e.opts.query)),
              (e.id = null),
              (e.upgrades = null),
              (e.pingInterval = null),
              (e.pingTimeout = null),
                        ...
                        if (!r)
                          if ("pong" === t.type && "probe" === t.data) {
                            if (
                              ...
                              return;
                            (h.priorWebsocketSuccess = "websocket" === n.name),
    ...
    function (t, e, n) {
      ...
      var y = n(10),
        ...
        b = n(3),
        m = b.pick,
        g = b.installTimerFunctions,
        k = n(0);
      function w() {}
      var O = null != new y({ xdomain: !1 }).responseType,
        _ = (function (t) {
          a(n, t);
          var e = f(n);
          function n(t) {
              ...
              },
              {
                ...
                value: function (t) {
                  if (void 0 !== this.xhr && null !== this.xhr) {
                    if (
                      (this.hasXDR()
                        ? (this.xhr.onload = this.xhr.onerror = w)
                        : (this.xhr.onreadystatechange = w),
                      t)
                    )
                      try {
                        this.xhr.abort();
